...
# Vercel frontend URL - using the most recent deployment
VERCEL_URL="https://goblin-frontend-dbmabskxk-fuaadabdullahs-projects.vercel.app"
...
ALLOWED_ORIGINS=https://goblin-frontend-dbmabskxk-fuaadabdullahs-projects.vercel.app,http://localhost:3000
...
[Service]
Environment="ALLOWED_ORIGINS=https://goblin-frontend-dbmabskxk-fuaadabdullahs-projects.vercel.app,http://localhost:3000"
...
echo "📝 Summary:"
echo "   - Vercel frontend URL: https://goblin-frontend-dbmabskxk-fuaadabdullahs-projects.vercel.app"
...
echo "2. Test the frontend-backend connection: curl -H 'Origin: https://goblin-frontend-dbmabskxk-fuaadabdullahs-projects.vercel.app' http://$BACKEND_HOST:8001/health"
echo "3. Access the frontend at: https://goblin-frontend-dbmabskxk-fuaadabdullahs-projects.vercel.app"