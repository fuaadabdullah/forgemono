...
2. Add a new Web Service (not a Static Site):
...
3. Connect the project to your GitHub / GitLab / Bitbucket repo
4. Configure the environment variables for your application on Render (VITE_FASTAPI_URL is not needed server-side; instead set secret keys used by the backend; set CORS domains, etc.)
5. Deploy: Render will automatically build and deploy the service on push
