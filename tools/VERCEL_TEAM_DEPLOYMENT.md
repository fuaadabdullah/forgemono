...
1. Click the account menu in the upper-left corner -> Create a Team
1. Enter Team name and create it

1. Upgrade the Team to Pro (billing)

1. In the Vercel Dashboard, switch to the new team
1. Go to Team Settings > Billing
1. Add a billing method (card) and choose Pro plan
1. Confirm and pay

1. Move or link project to the new Team
...
1. Use the 'Transfer' or 'Settings > General > Transfer Project' to move the project to the team

1. Ensure Environment Variables and Access
...
1. The CLI also allows `vercel env add` for adding environment variables for team-scoped projects
