...
class ChatController:
    ...
    async def _check_gateway_and_prepare(
        ...
        from backend.services import chat_controller_helpers
    ...
    async def orchestrate_completion(
        ...
        from backend.services import config_processor
    ...
    async def _execute_cloud_provider(
        ...
        """
        from backend.services import verification_processor, response_builder
