...
class ProviderHealthMonitor:
    ...
    HEALTH_ENDPOINTS = {
        ...
        # Legacy Kamatera (disabled - unreachable)
        "ollama_kamatera": ("http://192.175.23.150:8002", "/api/tags"),
        "llamacpp_kamatera": ("http://45.61.51.220:8000", "/health"),
    }
    ...
    async def _check_provider(
        ...
        if api_key:
            if provider_id in ["openai", "groq", "siliconeflow", "deepseek"]:
