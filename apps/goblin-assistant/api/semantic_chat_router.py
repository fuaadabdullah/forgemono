...
@datadog_trace("semantic_send_message")
...
@datadog_trace("get_context_bundle")
...
@datadog_trace("summarize_conversation")
...
@datadog_trace("search_memory_facts")
