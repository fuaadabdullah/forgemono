...
async def invoke_provider(
    ...
    async with httpx.AsyncClient(timeout=timeout) as client:
        # ---------- LLAMACPP (local and remote Colab) ----------
        if (
            pid in ["llamacpp", "llamacpp_colab"]
            ...
            if stream:
                ...
                try:
                    ...
                    # Skip garbled check for llamacpp_colab as it may have encoding issues
                    if pid != "llamacpp_colab" and garbled_ratio > 0.1:
                        return {
                            "ok": False,
