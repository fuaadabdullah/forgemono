...
2. Optional API key secret (`security.apiKey.secretName`) with key specified via `security.apiKey.secretKey`
3. Tempo, Loki, and Prometheus endpoints reachable inside the cluster
