...
export const metadata: Metadata = {
  ...
  description:
    'Complete sitemap for Elbey Projects mobile mechanic website. Find all our pages and services.',
};
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <section>
            ...
            <div className="space-y-2">
              {services.map((service) => (
                <div
                  key={service}
                  className="border border-gray-800 rounded-lg p-3 hover:border-red-600 transition-colors"
                >
        ...
        <section className="mt-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a
              href="/contact"
              className="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg text-center transition-colors"
            >
              Book Service
            </a>
            <a
              href="tel:+15551234567"
              className="bg-gray-800 hover:bg-gray-700 text-white px-4 py-2 rounded-lg text-center transition-colors"
            >
              Call Now
            </a>
            <a
