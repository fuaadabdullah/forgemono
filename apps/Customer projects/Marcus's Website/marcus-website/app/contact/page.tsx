...
export const metadata: Metadata = {
  ...
  description:
    'Get in touch with Elbey Projects for mobile mechanic services. Book your service online or call us directly. 24/7 emergency service available.',
};
      ...
      <section className="py-16 bg-gray-900">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg">Choose the method that works best for you</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-black rounded-lg p-6 border border-gray-800 text-center">
              ...
              <a href="tel:+15551234567" className="text-red-400 hover:text-red-300 font-semibold">
                (555) 123-4567
              </a>
            ...
            <div className="bg-black rounded-lg p-6 border border-gray-800 text-center">
              ...
              <p className="text-gray-300 mb-4">
                Send us details about your vehicle and service needs
              </p>
              <a
