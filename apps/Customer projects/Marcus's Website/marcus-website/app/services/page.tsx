...
export const metadata: Metadata = {
  ...
  description:
    'Professional mobile mechanic services: brakes, oil changes, diagnostics, suspension, engine service. We come to you for all your auto repair needs.',
};
...
const services = [
  {
    ...
    description:
      'Complete brake system inspection, pad replacement, rotor resurfacing, and fluid flush. Safety is our top priority.',
    features: [
  ...
  },
  {
    ...
    description:
      'Using the latest diagnostic equipment to identify issues before they become major problems. OBD-II scanning and troubleshooting.',
    features: [
      'OBD-II scanning',
  ...
  },
  {
    ...
    description:
      'Full synthetic oil changes with premium filters. All vehicles welcome, including diesel and European models.',
    features: [
      'Full synthetic oil',
      'Premium oil filter',
      'Multi-grade options',
  ...
  },
  {
    ...
    description:
      'Shock absorber replacement, alignment, and complete suspension component repairs for a smooth, safe ride.',
    features: [
  ...
  },
  {
    ...
    description:
      'Complete engine diagnostics, maintenance, and repair. From tune-ups to major rebuilds, we handle it all.',
  ...
  },
  {
    ...
    description:
      'Emergency roadside assistance and mobile repairs. We come to you - home, office, or breakdown location.',
    features: [
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-black rounded-lg p-6 border border-gray-800">
              ...
              <p className="text-gray-300 mb-4">
                Scheduled maintenance plans to keep your vehicle running smoothly and prevent
                breakdowns.
              </p>
          ...
          <div className="bg-red-600 rounded-lg p-8 text-white">
            ...
            <p className="mb-6">
              We handle all types of auto repairs and maintenance. If you don't see your service
