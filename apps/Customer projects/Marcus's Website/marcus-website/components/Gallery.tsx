  ...
  return (
    <section className="py-16 bg-gray-900">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-white">Our Work</h2>
                    ...
                    <div className="relative">
                      <div className="grid grid-cols-2 gap-1">
                        <div className="aspect-square bg-gray-800 overflow-hidden">
                          <picture>
                            <source
                              srcSet={`${before.replace('.jpg', '-256.webp')} 256w, ${before.replace('.jpg', '.webp')} 512w`}
                              type="image/webp"
                            />
                            <source
                              srcSet={`${before.replace('.jpg', '.avif')} 512w`}
                              type="image/avif"
                            />
                            <img
                              src={before}
                        ...
                        <div className="aspect-square bg-gray-800 overflow-hidden">
                          <picture>
                            <source
                              srcSet={`${after.replace('.jpg', '-256.webp')} 256w, ${after.replace('.jpg', '.webp')} 512w`}
                              type="image/webp"
                            />
                            <source
                              srcSet={`${after.replace('.jpg', '.avif')} 512w`}
                              type="image/avif"
                            />
                            <img
                              src={after}
